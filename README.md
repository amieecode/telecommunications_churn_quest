...
Telecommunications ChurnQuest explores patterns and factors that contribute to customer churn using real customer data. The project includes data cleaning, exploratory data analysis, feature engineering, and the creation of a churn analysis dashboard.
